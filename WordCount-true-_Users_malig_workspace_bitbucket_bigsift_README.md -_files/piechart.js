...
var svgContainer = d3.select("#col3").append("g").attr("id","graph");//.select("#graph");//.append("svg").attr("id","dag")
                     //.attr("width", 500)
                    //.attr("height", 900);
...
function drawCrossStageEdges(edges, svgContainer) {
    ...
    //the line and the pie chart should be rendered on a same svg
    var t1 = d3.select("#pieDagContainer").select("svg");
    var edgesContainer = t1.append("g").attr("id", "cross-stage-edges");
